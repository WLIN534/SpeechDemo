...
import com.zl.speachdemo.setting.TtsSettings;
import com.zl.speachdemo.utils.ApkInstaller;
...
public class MainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener ,View.OnClickListener{
    ...
    @BindView(R.id.text)
    EditText text;
    @BindView(R.id.tts_radioCloud)
    RadioButton ttsRadioCloud;
    @BindView(R.id.tts_radioLocal)
    RadioButton ttsRadioLocal;
    @BindView(R.id.tts_rediogroup)
    RadioGroup ttsRediogroup;//云端/本地单选按钮
    @BindView(R.id.tts_btn_person_select)
    Button ttsBtnPersonSelect;
    ...
    private void setLinster() {
        ttsRediogroup.setOnCheckedChangeListener(this);
        ttsCancel.setOnClickListener(this);
        ttsPause.setOnClickListener(this);
        ttsPlay.setOnClickListener(this);
        ttsResume.setOnClickListener(this);
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int checkId) {
        switch (checkId) {
            case R.id.tts_radioCloud://云端
                mEngineType = SpeechConstant.TYPE_CLOUD;
                break;
            case R.id.tts_radioLocal://本地
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
    ...
    private void showPresonSelectDialog() {
        switch (ttsRediogroup.getCheckedRadioButtonId()) {
            // 选择在线合成
